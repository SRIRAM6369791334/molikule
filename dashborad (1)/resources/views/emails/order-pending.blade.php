...
<head>
    <meta charset="utf-8">
    <title>Order Pending - {{ $order->order_number }}</title>
    <style>
        ...
        .pending-icon { font-size: 48px; margin-bottom: 10px; display: block; }
    </style>
</head>
<body>
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <p>Thank you for your order <strong>#{{ $order->order_number }}</strong>. We have received it and it is currently pending confirmation from our team.</p>
            
            <div class="order-info">
                <strong>Order Details:</strong><br>
                Status: <span class="status-badge">PENDING</span><br>
            ...
            <p style="margin-top: 40px;">We will process your order shortly. Thank you for your patience.</p>
