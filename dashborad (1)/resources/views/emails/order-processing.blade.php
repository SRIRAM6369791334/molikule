...
<head>
    <meta charset="utf-8">
    <title>Order Processing - {{ $order->order_number }}</title>
    <style>
        ...
        .processing-icon { font-size: 48px; margin-bottom: 10px; display: block; }
    </style>
</head>
<body>
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <p>We are currently processing your order <strong>#{{ $order->order_number }}</strong>. Our team is making sure everything is perfect before we send it out.</p>
            
            <div class="order-info">
                <strong>Order Details:</strong><br>
                Status: <span class="status-badge">PROCESSING</span><br>
            ...
            <p style="margin-top: 40px;">We'll notify you as soon as your order has been dispatched.</p>
