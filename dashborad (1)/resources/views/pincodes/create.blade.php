        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">
                    <i class="bx bx-plus-circle me-2 text-success"></i>Add New Pincode
                </h4>
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Pincode Information</h4>
                    <p class="card-title-desc">Add a new pincode for delivery service</p>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pincode') is-invalid @enderror"
                                        id="pincode" name="pincode" maxlength="10" value="{{ old('pincode') }}" required>
                                    @error('pincode')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" max="999999.99"
                                        class="form-control @error('cod_charge') is-invalid @enderror" id="cod_charge"
                                        name="cod_charge" value="{{ old('cod_charge', '120.00') }}">
                                    @error('cod_charge')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="text-end">
                                    ...
                                    <button type="submit" class="btn btn-success">
                                        <i class="bx bx-save me-1"></i>Create Pincode
                                    </button>
                                </div>
                            </div>
                        </div>
