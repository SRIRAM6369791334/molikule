        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('certificates.store') }}" enctype="multipart/form-data">
                    ...
                    {{-- Image --}}
                    <div class="mb-4">
                        <label for="image" class="form-label fw-semibold">Certificate Image <span class="text-danger">*</span></label>
                        <input type="file"
                               ...
                               required>
                        <div class="form-text">Accepted: JPEG, PNG, WebP. Max 5 MB.</div>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <div id="imgPreview" class="mt-3" style="display:none;">
                            <img id="previewImg" src="" alt="Preview"
                                 style="max-height:160px; border-radius:12px; border:1px solid #e2e8f0; padding:6px; background:#f8fafc;">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary px-4" id="submitBtn">
                            <i class="bx bx-save me-1"></i> Save Certificate
                        </button>
                    </div>
                </form>
            </div>
