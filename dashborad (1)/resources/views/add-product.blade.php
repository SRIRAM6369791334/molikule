@extends('layouts.app')
@section('title') Launch New Product | Molikule Enterprise @endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Launch New Product</h4>
                        ...
                        <div class="card-body p-4">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <div id="image-preview-container"
                                            class="border rounded bg-light d-none overflow-hidden" style="height: 100px;">
                                            <img id="image-preview" src="" class="img-fluid h-100 w-100"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="short_description" name="short_description" class="form-control"
                                    value="{{ old('short_description') }}" placeholder="Brief highlight line for list views"
                                    required>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="initial_flavour" name="variant_value"
                                            placeholder="e.g. Lemon" required oninput="syncPreviewName()">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="variant_sku" placeholder="Unique SKU"
                                            required>
                                    </div>
                                    <div class="col-12 mt-3">
                                        <div class="bg-white p-2 rounded border">
                                            <small class="text-muted d-block">Variant Preview:</small>
                                            <h6 class="mb-0 text-primary" id="variant_preview_title">Enter details...
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="wizard-step" id="step-3">
                    <div class="card premium-card mb-4">
                        <div class="card-body p-4">
                            ...
                            {{-- Hidden optional fields removed per user request --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="0.01" id="width" name="width" class="form-control" required>
                                </div>
                                <div class="col-md-3 mb-3">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn btn-success btn-lg px-5 fw-bold" id="submit-btn">
                                    Launch Product Now <i class="bx bx-rocket ms-1"></i>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function nextStep(step) {
            ...
            $(`#step-${currentStep} [required]`).each(function () {
                if (!$(this).val()) {
                    // Only show visual warning for non-select fields to keep Select2 clean
                    if (!$(this).is('select')) {
                ...
                reader.onload = function (e) {
                    ...
                    img.onload = function () {
                        if (this.width !== 1080 || this.height !== 1080) {
                            ...
                            container.removeClass('d-none').addClass('animate__animated animate__fadeIn');
                        }
                    };

                    img.onerror = function () {
                        Swal.fire('Invalid File', 'The selected file is not a valid image.', 'error');
                        input.value = '';
                        container.addClass('d-none');
                    };
                };
