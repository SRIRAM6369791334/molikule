...
<head>
    ...
    <title>Reset Your Password - Molikule</title>
    <style>
                        ...
                        <td align="center">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="email-card">
                                ...
                                <tr>
                                    <td class="content">
                                        <p>Hello,</p>
                                        <p>We received a request to reset the password for your Molikule Green Care account. Click the button below to choose a new password:</p>
                                        
                                        <div class="btn-wrapper">
                                            <a href="{{ $resetLink }}" class="btn">Reset Password</a>
                                        </div>
                                        
                                        <p style="font-size: 14px; margin-top: 25px;">This link will expire in 60 minutes.</p>
